...
var mainState = 
{
	...
	create : function()
	{
	    var s = game.add.tileSprite(0, 0, 800, 600, 'room0');

		var lbutton = game.add.button(game.world.centerX - 95, 300, 'button_left', move_left, this, 2, 1, 0);
		lbutton.scale.setTo(0.25, 0.25);
		lbutton.onInputDown.add(buttonDownLeft, this);
		lbutton.onInputUp.add(buttonUpLeft, this);

		var rbutton = game.add.button(game.world.centerX + 25, 300, 'button_right', move_right, this, 2, 1, 0);
	...
	update : function()
	{
		...
		var pos = white_spy.updateMovement();

		//if ( pos != null )
		//	client.sendSocketData( 'posdata', pos );
	},
};
